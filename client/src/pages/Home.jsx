...
const GITHUB_API = `https://api.github.com/users/${import.meta.env.VITE_GITHUB_USERNAME || "SuyogChavan2005"}`;
...
const Home = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 mt-10 sm:mt-5 md:mt-5 lg:mt-10">
      <div className="text-center relative z-10 max-w-4xl mx-auto">
        ...
        <motion.div
          className="grid lg:grid-cols-4 sm:grid-cols-2 justify-items-center gap-6 mt-8 sm:mt-12 max-w-xs sm:max-w-none mx-auto"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          ...
          >
            <div className="p-3 rounded-xl transition-colors mb-2 w-full max-w-[200px]">
              <Youtube className="w-5 h-5 sm:w-6 sm:h-6 text-gray-400 group-hover:text-white transition-colors mx-auto" />
            </div>
            <span className="text-base sm:text-lg font-semibold">
              {CONTACT_INFO.displaySubscribers}
            </span>

...
import bscPdf from "@/assets/files/education_pdf/B.Sc CS.pdf";
import hsMarkSheetPdf from "@/assets/files/education_pdf/HS MARK SHEET.pdf";

const educationData = [
  {
    id: 1,
    school: "M.D. College of Arts, Science and Commerce",
    ...
    description:
      "During my B.Sc. in Computer Science, I developed a strong foundation in programming, software development, and problem-solving. Through practical projects, coursework, and hands-on learning, I strengthened my technical skills while gaining experience in building real-world applications and improving my analytical thinking.",
  },
  {
    id: 2,
    school: "M.D. College of Arts, Science and Commerce",

...
import paritriptiImg from "@/assets/experience/paritripti.jpg";
import IIDEImg from "@/assets/experience/IIDE.jpg";
import IIDEPdf from "@/assets/files/experience_pdf/IIDE.pdf";
import paritriptiPdf from "@/assets/files/experience_pdf/paritripti.pdf";
...
const experiences = [
  {
    ...
    type: "Internship",
    image: paritriptiImg,
    certificateUrl: paritriptiPdf,
    description: [
      "Developed a number of responsive and dynamic themes for the next major project.",
      "Designed and developed a flexible and dynamic frontend for a inventory management system.",
    ],
  },
  {
    id: 2,
    ...
    type: "Internship",
    image: IIDEImg,
    certificateUrl: IIDEPdf,
    description: [
      "Completed a Digital Marketing program at IIDE, covering SEO, social media, content marketing, and analytics.",
      "Gained practical experience through hands-on projects and guidance from industry professionals.",
    ],
  },
